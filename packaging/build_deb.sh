...
# dependency .debs from /prebuilt, then builds pairs_octomap_planner and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_lib pairs_msgs pairs_modules_msgs pairs_octomap_tools pairs_subt_planning_lib
set -eo pipefail
ROS_DISTRO_NAME="jazzy"; OS_NAME="ubuntu"; OS_VERSION="noble"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_octomap_planner/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_octomap_planner
