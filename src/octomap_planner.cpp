...
#include <pairs_modules_msgs/msg/octomap_planner_diagnostics.hpp>

#include <std_srvs/srv/trigger.hpp>

#include <pairs_octomap_planner/astar_planner.hpp>
#include <pairs_subt_planning_lib/astar_planner.h>
...
namespace pairs_octomap_planner
{
  ...
  class OctomapPlanner : public pairs_lib::Node
  {
  ...
  private:
    ...
    pairs_lib::PublisherHandler<pairs_modules_msgs::msg::OctomapPlannerDiagnostics> pub_diagnostics_;
    pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_virtual_obstacles_;
    ...
    // service servers
    rclcpp::Service<pairs_msgs::srv::Vec4>::SharedPtr service_server_goto_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr service_server_stop_;
    rclcpp::Service<pairs_msgs::srv::ReferenceStampedSrv>::SharedPtr service_server_reference_;
    rclcpp::Service<pairs_msgs::srv::String>::SharedPtr service_server_set_planner_;
    rclcpp::Service<pairs_msgs::srv::Vec1>::SharedPtr service_server_set_safety_distance_;
    rclcpp::Service<pairs_msgs::srv::Vec1>::SharedPtr service_server_set_max_altitude_;
    rclcpp::Service<pairs_msgs::srv::ValidateReferenceArray>::SharedPtr service_server_add_virtual_obstacle_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr service_server_remove_virtual_obstacles_;

    // service server callbacks
    void callbackGoto(const std::shared_ptr<pairs_msgs::srv::Vec4::Request> req, const std::shared_ptr<pairs_msgs::srv::Vec4::Response> res);
    ...
    void callbackReference(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request> req,
                           const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> res);
    void callbackSetPlanner(const std::shared_ptr<pairs_msgs::srv::String::Request> req, const std::shared_ptr<pairs_msgs::srv::String::Response> res);
    void callbackSetSafetyDistance(const std::shared_ptr<pairs_msgs::srv::Vec1::Request> req, const std::shared_ptr<pairs_msgs::srv::Vec1::Response> res);
    void callbackSetMaxAltitude(const std::shared_ptr<pairs_msgs::srv::Vec1::Request> req, const std::shared_ptr<pairs_msgs::srv::Vec1::Response> res);
    void callbackAddVirtualObstacle(const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Request> req,
                                    const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Response> res);
    void callbackRemoveVirtualObstacles([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> req,
                                        const std::shared_ptr<std_srvs::srv::Trigger::Response> res);

    // service clients
    pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetPathSrv> sc_get_trajectory_;
    pairs_lib::ServiceClientHandler<pairs_msgs::srv::TrajectoryReferenceSrv> sc_trajectory_reference_;
    pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger> sc_hover_;
    ...
    // diagnostics
    pairs_modules_msgs::msg::OctomapPlannerDiagnostics diagnostics_;
    ...
    pairs_msgs::msg::Reference user_goal_;
    ...
    // routines
    void setReplanningPoint(const pairs_msgs::msg::TrajectoryReference& traj);
     ...
     */
    std::optional<pairs_msgs::msg::ReferenceStamped> getInitialCondition(const rclcpp::Time time);
  ...
  OctomapPlanner::OctomapPlanner(const rclcpp::NodeOptions& options) : pairs_lib::Node("octomap_planner", options)
  {
    initialize();
  }
  ...
  void OctomapPlanner::initialize()
  {
    ...
    param_loader.setPrefix("pairs_octomap_planner/octomap_planner/");
    ...
    if (_restart_planner_on_deadlock_)
    {
      ...
      {
        RCLCPP_WARN(node_->get_logger(),
                    "Timeout factor for planner deadlock detection was set too low (< 3.0). Setting factor to 3.0 to prevent premature killing of "
                    "the planner.");
        _planner_deadlock_timeout_factor = 3.0;
      }

      planner_deadlock_timeout_ = _planner_deadlock_timeout_factor * _timeout_threshold_;
      RCLCPP_INFO(node_->get_logger(), "Planner deadlock timeout set to %.2f s.", planner_deadlock_timeout_);
    }
    ...
    pub_diagnostics_ = pairs_lib::PublisherHandler<pairs_modules_msgs::msg::OctomapPlannerDiagnostics>(phopts, "~/diagnostics_out");
    pub_virtual_obstacles_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(phopts, "~/virtual_obstacles_out");
    ...
    sh_tracker_cmd_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::TrackerCommand>(shopts, "~/tracker_cmd_in", rclcpp::Duration::from_seconds(3.0),
                                                                                &OctomapPlanner::timeoutTrackerCmd, this);
    sh_octomap_ = pairs_lib::SubscriberHandler<octomap_msgs::msg::Octomap>(shopts, "~/octomap_in", rclcpp::Duration::from_seconds(5.0),
                                                                         &OctomapPlanner::timeoutOctomap, this, &OctomapPlanner::callbackOctomap, this);

    sh_control_manager_diag_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::ControlManagerDiagnostics>(
    ...
    sc_get_trajectory_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetPathSrv>(node_, "~/trajectory_generation_out");
    sc_trajectory_reference_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::TrajectoryReferenceSrv>(node_, "~/trajectory_reference_out");
    sc_hover_ = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/hover_out");
    ...
    bv_input_ = pairs_lib::BatchVisualizer(node_, "visualize_input", "");
    ...
    bv_processed_ = pairs_lib::BatchVisualizer(node_, "visualize_processed", "");
    ...
    timer_publish_virtual_obstacles_ =
        std::make_shared<TimerType>(timer_opts_start, rclcpp::Rate(_rate_virtual_obstacle_pub_timer_, clock_), callback_timer_publish_virtual_obstacles_);
    ...
    service_server_goto_ =
        node_->create_service<pairs_msgs::srv::Vec4>("~/goto_in", std::bind(&OctomapPlanner::callbackGoto, this, std::placeholders::_1, std::placeholders::_2));
    service_server_stop_ = node_->create_service<std_srvs::srv::Trigger>(
        "~/stop_in", std::bind(&OctomapPlanner::callbackStop, this, std::placeholders::_1, std::placeholders::_2));
    service_server_reference_ = node_->create_service<pairs_msgs::srv::ReferenceStampedSrv>(
        "~/reference_in", std::bind(&OctomapPlanner::callbackReference, this, std::placeholders::_1, std::placeholders::_2));
    service_server_set_planner_ = node_->create_service<pairs_msgs::srv::String>(
        "~/planner_type_in", std::bind(&OctomapPlanner::callbackSetPlanner, this, std::placeholders::_1, std::placeholders::_2));
    service_server_set_safety_distance_ = node_->create_service<pairs_msgs::srv::Vec1>(
        "~/set_safety_distance_in", std::bind(&OctomapPlanner::callbackSetSafetyDistance, this, std::placeholders::_1, std::placeholders::_2));
    service_server_set_max_altitude_ = node_->create_service<pairs_msgs::srv::Vec1>(
        "~/set_max_altitude_in", std::bind(&OctomapPlanner::callbackSetMaxAltitude, this, std::placeholders::_1, std::placeholders::_2));
    service_server_add_virtual_obstacle_ = node_->create_service<pairs_msgs::srv::ValidateReferenceArray>(
        "~/add_virtual_obstacle_in", std::bind(&OctomapPlanner::callbackAddVirtualObstacle, this, std::placeholders::_1, std::placeholders::_2));
  ...
  void OctomapPlanner::timeoutTrackerCmd([[maybe_unused]] const std::string& topic, [[maybe_unused]] const rclcpp::Time& last_msg)
  {
    ...
    if (state_ != STATE_IDLE)
    {
      ...
      RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000, "position cmd timeouted!");
  ...
  void OctomapPlanner::timeoutOctomap([[maybe_unused]] const std::string& topic, [[maybe_unused]] const rclcpp::Time& last_msg)
  {
    ...
    if (state_ != STATE_IDLE)
    {
      RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000, "octomap timeouted!");
  ...
  void OctomapPlanner::timeoutControlManagerDiag([[maybe_unused]] const std::string& topic, [[maybe_unused]] const rclcpp::Time& last_msg)
  {
    ...
    if (state_ != STATE_IDLE)
    {
      ...
      RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000, "Control manager diag timeouted!");
                                    ...
                                    std::shared_ptr<std_srvs::srv::Trigger::Response> res)
  {
    ...
    if (!ready_to_plan_)
    {
      ...
      RCLCPP_ERROR_STREAM_THROTTLE(node_->get_logger(), *clock_, 500, "" << ss.str());
  ...
  /* callbackGoto() //{ */
  void OctomapPlanner::callbackGoto(const std::shared_ptr<pairs_msgs::srv::Vec4::Request> req, const std::shared_ptr<pairs_msgs::srv::Vec4::Response> res)
  {
    ...
    {
      pairs_msgs::msg::TrackerCommand::ConstSharedPtr tracker_cmd = sh_tracker_cmd_.getMsg();
  ...
  void OctomapPlanner::callbackReference(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request> req,
                                         const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> res)
  {
    ...
    // | -------- transform the reference to the map frame -------- |
    {
      ...
      pairs_msgs::msg::ReferenceStamped ref_stamped;
  ...
  void OctomapPlanner::callbackSetPlanner(const std::shared_ptr<pairs_msgs::srv::String::Request> req, const std::shared_ptr<pairs_msgs::srv::String::Response> res)
  {
    ...
    RCLCPP_INFO(node_->get_logger(), "Setting planner to %s requested.", req->value.c_str());
    res->success = true;
  ...
  void OctomapPlanner::callbackSetSafetyDistance(const std::shared_ptr<pairs_msgs::srv::Vec1::Request> req,
                                                 const std::shared_ptr<pairs_msgs::srv::Vec1::Response> res)
  {
    ...
    if (req->goal >= _safe_obstacle_distance_min_ && req->goal <= _safe_obstacle_distance_max_)
    {

      {
        ...
        _euclidean_distance_cutoff_ = _safe_obstacle_distance_ + 0.01; // needed for correct function of PAIRS planner
      }

      RCLCPP_INFO(node_->get_logger(), "setting safety distance to %.2f m.", _safe_obstacle_distance_);
      res->success = true;

    } else
    {

      RCLCPP_WARN(node_->get_logger(), "failed to set safety distance %.2f m (outside the allowed range [%.2f, %.2f])", req->goal, _safe_obstacle_distance_min_,
  ...
  void OctomapPlanner::callbackSetMaxAltitude(const std::shared_ptr<pairs_msgs::srv::Vec1::Request> req, const std::shared_ptr<pairs_msgs::srv::Vec1::Response> res)
  {
    ...
    RCLCPP_INFO(node_->get_logger(), "setting max altitude to %.2f m.", _max_altitude_);
    res->success = true;
  ...
  void OctomapPlanner::callbackAddVirtualObstacle(const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Request> req,
                                                  const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Response> res)
  {
    ...
    std::string octree_frame = pairs_lib::get_mutexed(mutex_octree_, octree_frame_);
    std::vector<pairs_msgs::msg::Reference> virt_obst_in_octree_frame;
    ...
    RCLCPP_INFO(node_->get_logger(), "[PairsOctomapPlanner] adding virtual obstacle");
  ...
  void OctomapPlanner::callbackRemoveVirtualObstacles([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> req,
                                                      const std::shared_ptr<std_srvs::srv::Trigger::Response> res)
  {
  ...
  void OctomapPlanner::timerMain()
  {
    ...
    {
      RCLCPP_INFO_THROTTLE(node_->get_logger(), *clock_, 1000, "waiting for data: octomap = %s, position cmd = %s, ControlManager diag = %s, constraints = %s",
    ...
    const auto user_goal = pairs_lib::get_mutexed(mutex_user_goal_, user_goal_);
    ...
    const pairs_msgs::msg::ControlManagerDiagnostics::ConstSharedPtr control_manager_diag = sh_control_manager_diag_.getMsg();
    const pairs_msgs::msg::TrackerCommand::ConstSharedPtr tracker_cmd = sh_tracker_cmd_.getMsg();
    ...
    case STATE_PLANNING: {
      ...
      pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "timerMain - STATE_PLANNING", scope_timer_logger_, _scope_timer_enabled_);

      if (!octree->getRoot())
      {

        RCLCPP_ERROR(node_->get_logger(), "don't have a map");
      ...
      if (replanning_counter_ >= _max_attempts_to_replan_)
      {
        ...
        RCLCPP_ERROR(node_->get_logger(), "planning failed, the uav is stuck");
      ...
      RCLCPP_INFO(node_->get_logger(), "planning timeout %.2f s", time_for_planning_s);
      ...
      RCLCPP_INFO(node_->get_logger(),"planning timeout %.2f s", time_for_planning);
      */

      rclcpp::Time init_cond_time = clock_->now() + rclcpp::Duration::from_seconds(time_for_planning_s + _time_for_trajectory_generator_);

      RCLCPP_INFO(node_->get_logger(), "init cond time %.2f s", init_cond_time.seconds());
      ...
      while (!initial_condition && iter < 20)
      {
        ...
        RCLCPP_WARN(node_->get_logger(), "Trying to get initial condition updated with the last sent path.");
      ...
      if (!initial_condition)
      {
        ...
        RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "could not obtain initial condition for planning");
        hover();
        changeState(STATE_IDLE);
      ...
      // RCLCPP_INFO(node_->get_logger(),"init cond time stamp %.2f", (initial_condition.value().header.stamp.seconds());
      ...
      if ((plan_from - user_goal_octpoint).norm() <= _min_path_length_
          && pairs_lib::geometry::radians::dist(initial_condition.value().reference.heading, user_goal_.heading) < _min_path_heading_change_)
      {

        RCLCPP_INFO_THROTTLE(node_->get_logger(), *clock_, 1000, "we reached the target");
        changeState(STATE_IDLE);
        break;
      }
      /*//}*/
      ...
      auto safe_obstacle_distance = pairs_lib::get_mutexed(mutex_safety_distance_, _safe_obstacle_distance_);
      auto max_altitude = pairs_lib::get_mutexed(mutex_max_altitude_, _max_altitude_);


      if ((plan_from - user_goal_octpoint).norm() <= 2 * sqrt(3) * planning_tree_resolution_)
      { // enable planning on a short range and change of the heading without translation
        ...
        {
          RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 100, "collision check of short direct path failed, could not raytrace!");
          is_direct_path_collision_free = false;
          break;
        }
        ...
        } else
        {
          ...
          RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000, "direct short path does not exist.");
          changeState(STATE_IDLE);
          break;
        }
      ...
      } else
      {
        ...
        if (_use_subt_planner_)
        {
          ...
          // | -------------------- PAIRS SubT planner -------------------- |
          pairs_subt_planning::AstarPlanner subt_planner = pairs_subt_planning::AstarPlanner(node_);

          subt_planner.initialize(true, time_for_planning_s - _subt_processing_timeout_, _subt_processing_timeout_, safe_obstacle_distance,
                                  _subt_clearing_dist_, _min_altitude_, max_altitude, _subt_debug_info_, bv_planner_, false);
          subt_planner.setAstarAdmissibility(_subt_admissibility_);

          RCLCPP_INFO(node_->get_logger(), "Calling find path method.");
        ...
        } else
        {
          ...
          pairs_octomap_planner::AstarPlanner planner =
              pairs_octomap_planner::AstarPlanner(node_, "PairsOctomapPlanner PAIRS Astar Planner", safe_obstacle_distance, _euclidean_distance_cutoff_,
                                                _distance_transform_distance_, planning_tree_resolution_, _distance_penalty_, _greedy_penalty_,
      ...
      if (waypoints.second)
      {
        ...
        RCLCPP_INFO(node_->get_logger(), "Path is complete. Path length = %lu", waypoints.first.size());

      } else
      {

        RCLCPP_INFO(node_->get_logger(), "Path is not complete");
        ...
        RCLCPP_INFO(node_->get_logger(), "Path is not complete but found");
        ...
        if (path_start_end_dist < _min_path_length_)
        {
          ...
          RCLCPP_WARN(node_->get_logger(), "path too short, length: %.3f", path_start_end_dist);
        ...
        if (!detected_collision_ && !first_planning_for_current_goal_ && path_end_to_goal_dist > _goal_reached_dist_
            && path_end_to_goal_dist < _max_goal_dist_to_disable_replanning_)
        { // goal unreachable
          ...
          if (dist_to_goal_prev - dist_to_goal_current < _min_dist_to_goal_improvement_)
          {
            ...
            RCLCPP_INFO_THROTTLE(node_->get_logger(), *clock_, 1000, "Insufficient improvement in dist to goal. Aborting the planning to avoid oscillations.");
...

      {
        ...
        auto octree_frame = pairs_lib::get_mutexed(mutex_octree_, octree_frame_);

        // transform the position cmd to the map frame
        pairs_msgs::msg::ReferenceStamped position_cmd_ref;
        ...
        if (!res)
        {
          RCLCPP_ERROR(node_->get_logger(), "could not transform position cmd to the map frame");
          return;
        }
      ...
      RCLCPP_INFO(node_->get_logger(), "Calling path service with timestamp = %.3f at time %.3f.", path_stamp.seconds(), clock_->now().seconds());
      rclcpp::Time tg_start = clock_->now();

      /*
      pairs_msgs::srv::GetPathSrv srv_get_path;
      ...
      */
      ...
      std::shared_ptr<pairs_msgs::srv::GetPathSrv::Request> req_path = std::make_shared<pairs_msgs::srv::GetPathSrv::Request>();
      ...
      for (unsigned int i = 0; i < waypoints.first.size(); i++)
      {
        ...
        if (_turn_in_flight_direction_)
        {
          ...
          if (i < waypoints.first.size() - 1)
          { // heading in the direction of flying with prevention of fast turning due to quick changes of path directions
        ...
        if (i > 0)
        {
          ...
          {
            pairs_msgs::msg::Reference inter_ref;
            ...
            /* RCLCPP_INFO(node_->get_logger(),"TG inter input point %02d: [%.2f, %.2f, %.2f, %.2f]", i, inter_ref.position.x,
             * inter_ref.position.y, */
            /* inter_ref.position.z, inter_ref.heading); */
          }
        }

        RCLCPP_INFO(node_->get_logger(), "TG input point %02d: [%.2f, %.2f, %.2f, %.2f]", i, ref.position.x, ref.position.y, ref.position.z, ref.heading);
        req_path->path.points.push_back(ref);
        ...
        {
          RCLCPP_INFO(node_->get_logger(), "cutting path in waypoint %d out of %d", i, int(waypoints.first.size()));
          break;
        }
      }
      ...
      if (interrupted_)
      {
        RCLCPP_WARN(node_->get_logger(), "planner interrupted, breaking main timer");
        break;
      }

      RCLCPP_INFO(node_->get_logger(), "calling trajectory generation");
      ...
      if (!res_path)
      {
        RCLCPP_ERROR(node_->get_logger(), "service call for trajectory failed");
        break;
      } else
      {
        if (!res_path.value()->success)
        {
          RCLCPP_ERROR(node_->get_logger(), "service call for trajectory failed: '%s'", res_path.value()->message.c_str());
          break;
        }
      }


      RCLCPP_INFO(node_->get_logger(), "Trajectory generation took %.2f s", (clock_->now() - tg_start).seconds());
      ...
      for (unsigned int i = 0; i < trajectory.points.size() - 1; i++)
      {
        ...
        if (octree->computeRayKeys(point1, point2, key_ray))
        {
          for (octomap::KeyRay::iterator it1 = key_ray.begin(), end = key_ray.end(); it1 != end; ++it1)
          {
            ...
            if (node && octree->isNodeOccupied(node))
            {
              RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 100,
                                    "trajectory check found collision with prediction horizon between %d and %d, replanning!", i, i + 1);
              ray_is_cool = false;
              break;
            }
          }
        ...
        {
          RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 100, "trajectory check failed, could not raytrace!");
          ray_is_cool = false;
          break;
        }
      }
      ...
      RCLCPP_INFO(node_->get_logger(), "publishing trajectory reference");

      // pairs_msgs::srv::TrajectoryReferenceSrv srv_trajectory_reference;
      std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request> req_traj = std::make_shared<pairs_msgs::srv::TrajectoryReferenceSrv::Request>();
      ...
      RCLCPP_INFO(node_->get_logger(), "Calling trajectory service with timestamp = %d at time %.3f.", req_traj->trajectory.header.stamp.sec,
                  clock_->now().seconds());
      ...
      if (!res_traj)
      {
        RCLCPP_ERROR(node_->get_logger(), "service call for trajectory reference failed");
        break;
      } else
      {
        if (!res_traj.value()->success)
        {
          RCLCPP_ERROR(node_->get_logger(), "service call for trajectory reference failed: '%s'", res_traj.value()->message.c_str());
          break;
        }
      }
    ...
    case STATE_MOVING: {
      ...
      RCLCPP_INFO_THROTTLE(node_->get_logger(), *clock_, 1000, "dist to goal: %.2f m", dist_to_goal);

      if (dist_to_goal < _goal_reached_dist_)
      {
        RCLCPP_INFO(node_->get_logger(), "user goal reached");
        changeState(STATE_IDLE);
        break;
      }
      ...
      if ((clock_->now().seconds() - (time_last_plan_.seconds() + _replan_after_)) > 0.0)
      {
        ...
        RCLCPP_INFO(node_->get_logger(), "triggering replanning");
  ...
  void OctomapPlanner::timerFutureCheck()
  {
    ...
    RCLCPP_INFO_ONCE(node_->get_logger(), "future check timer spinning");
    const pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "timerFutureCheck", scope_timer_logger_, _scope_timer_enabled_);
    ...
    if (!octree->getRoot())
    {
      RCLCPP_ERROR(node_->get_logger(), "cannot check for collision, don't have a map");
      return;
    }

    pairs_msgs::msg::MpcPredictionFullState prediction = sh_tracker_cmd_.getMsg()->full_state_prediction;
    pairs_msgs::msg::ControlManagerDiagnostics::ConstSharedPtr control_manager_diag = sh_control_manager_diag_.getMsg();
    ...
    if (control_manager_diag->flying_normally && control_manager_diag->tracker_status.have_goal)
    {
      ...
      if (!ret)
      {
        RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "could not transform position cmd to the map frame! can not check for potential collisions!");
        return;
      }
      ...
      for (unsigned int i = 1; i < prediction.position.size(); i++)
      {
        ...
        pairs_msgs::msg::ReferenceStamped pose;
        ...
        if (!transformed_pose)
        {
          RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000,
                                "could not transform position cmd to the map frame! can not check for potential collisions!");
          return;
        }
        ...
        for (double phi = -M_PI; phi < M_PI; phi += angle_step)
        {
          ...
          if (octree->computeRayKeys(point1, point_ray_end, ray))
          {
            for (octomap::KeyRay::iterator it = ray.begin(), end = ray.end(); it != end; ++it)
            {
              ...
              if (!node)
              {
                /* RCLCPP_WARN(node_->get_logger(),"Detected UNKNOWN space along the planned trajectory!"); */
              } else if (octree->isNodeOccupied(node))
              {
                /* RCLCPP_WARN(node_->get_logger(),"Detected OCCUPIED space along the planned trajectory!"); */
                ...
                RCLCPP_WARN(node_->get_logger(), "Detected OCCUPIED space along the planned trajectory! Cropped the trajectory to %d from %d points.",
                            int(trajectory.points.size()), orig_traj_size);

                std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request> req_traj_ref =
                    std::make_shared<pairs_msgs::srv::TrajectoryReferenceSrv::Request>();
                ...
                } else
                {
                  ...
                  {
                    RCLCPP_ERROR(node_->get_logger(), "service call for trajectory reference failed: '%s'", res_traj_ref.value()->message.c_str());
                    break;
                  }
                }
          ...
          {
            RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000, "Unable to raycast.");
          }
          if (cropped_trajectory)
          {
            break;
      ...
      for (unsigned int i = 0; i < trajectory.points.size() - 1; i++)
      {
        ...
        if (octree->computeRayKeys(point1, point2, key_ray))
        {
          ...
          if (!ray_is_cool)
          {
            ...
            RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 100, "future check found collision with prediction horizon between %d and %d, hovering!", i,
                                  i + 1);
        ...
        } else
        {
          ...
          RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 100, "future check failed, could not raytrace!");
          hover();
          break;
        }
      }
  ...
  void OctomapPlanner::timerDiagnostics()
  {
    ...
    auto diagnostics = pairs_lib::get_mutexed(mutex_diagnostics_, diagnostics_);

    pub_diagnostics_.publish(diagnostics);

    auto planner_time_flag = pairs_lib::get_mutexed(mutex_planner_time_flag_, planner_time_flag_);
    ...
    if (_restart_planner_on_deadlock_ && planner_time_flag.seconds() > 0)
    {
      ...
      {
        RCLCPP_ERROR(node_->get_logger(), "Planner is deadlocked, restarting!");
        rclcpp::shutdown();
        exit(1);
      }
    }
  ...
  void OctomapPlanner::setReplanningPoint(const pairs_msgs::msg::TrajectoryReference& traj)
  {
    ...
    pairs_lib::geometry::Cuboid c(Eigen::Vector3d(x, y, z), Eigen::Vector3d(0.4, 0.4, 0.4), Eigen::Quaterniond::Identity());

    {
      std::scoped_lock lock(mutex_bv_input_);

      auto user_goal = pairs_lib::get_mutexed(mutex_user_goal_, user_goal_);
  ...
  void OctomapPlanner::changeState(const State_t new_state)
  {
    ...
    {
      RCLCPP_WARN(node_->get_logger(), "Planning interrupted, not changing state.");
      return;
    }
    ...
    RCLCPP_INFO(node_->get_logger(), "changing state '%s' -> '%s'", _state_names_[old_state].c_str(), _state_names_[new_state].c_str());
  ...
  std::optional<pairs_msgs::msg::ReferenceStamped> OctomapPlanner::getInitialCondition(const rclcpp::Time des_time)
  {

    const pairs_msgs::msg::MpcPredictionFullState prediction_full_state = sh_tracker_cmd_.getMsg()->full_state_prediction;

    if (prediction_full_state.input_id != 0 && prediction_full_state.input_id < path_id_)
    {
      RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000,
                            "could not obtain initial condition, the input_id (%lu) does not match id of last sent path (%d).", prediction_full_state.input_id,
                            path_id_);
      return {};
    }
    ...
    {
      RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "Could not obtain initial condition, prediction full state is empty.");
      return {};
    }

    if ((des_time - prediction_full_state.stamps.back()).seconds() > 0)
    {
      RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "could not obtain initial condition, the desired time is too far in the future");
      return {};
    }

    pairs_msgs::msg::ReferenceStamped orig_reference;
    ...
    if (result)
    {
      ...
      pairs_msgs::msg::ReferenceStamped transformed_reference = result.value();
  ...
  void OctomapPlanner::hover(void)
  {
    ...
    RCLCPP_INFO(node_->get_logger(), "triggering hover, interrupting planner");
  ...
  std::vector<double> OctomapPlanner::estimateSegmentTimes(const std::vector<Eigen::Vector4d>& vertices, const bool use_heading)
  {
    ...
    const pairs_msgs::msg::DynamicsConstraints::ConstSharedPtr constraints = sh_constraints_.getMsg();
    ...
    for (size_t i = 0; i < check; i++)
    {
      ...
      double angular_distance = fabs(pairs_lib::geometry::radians::dist(start_hdg, end_hdg));
    ...
    for (const auto& obst : virtual_obstacles_)
    {
      ...
      if (obst.frame_id != octree_frame_)
      {
        RCLCPP_WARN_THROTTLE(node_->get_logger(), *clock_, 1000,
                             "[PairsOctomapPlanner] not adding virtual obstacle because it's frame_id (%s) doesn't match octree_frame (%s)",
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_octomap_planner::OctomapPlanner)
